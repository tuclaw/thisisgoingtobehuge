...
const FALLBACK_SEASON = {
  ...
  "tribes": [
    {
      ...
      "buff": "ocean teal",
      "color": "#0E6B6B",
      "combinedWeekPct": 3.81,
      "combinedMonthPct": 3.81,
      "livingCount": 6,
      "combinedDayPct": 2.74
    },
    {
  ...
  "markLabel": "Thu Aug 27 mid (~9:47 AM PT) remake from Robinhood last_trade (in-session)",
