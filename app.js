...
const FALLBACK_SEASON = {
  ...
  "tribes": [
    {
      ...
      "buff": "ocean teal",
      "color": "#0E6B6B",
      "combinedWeekPct": 3.96,
      "combinedMonthPct": 3.96,
      "livingCount": 6,
      "combinedDayPct": 2.94
    },
    {
      ...
      "buff": "ember orange",
      "color": "#C45A12",
      "combinedWeekPct": 4.16,
      "combinedMonthPct": 4.16,
      "livingCount": 6,
      "combinedDayPct": 6.5
    }
  ],
  "survivors": [
    ...
    },
    {
      ...
      "position": {
        ...
        "sizeUsd": 10,
        "status": "filled",
        "note": "NVDA 0.007098 @ 211.3199 + MSFT 0.004037 @ 495.3041 ($2) + COST 0.002092 @ 955.8499 ($2) + cash $4.6065. Thu sell NVDA 0.007098 @ 226.330700 (order 6a908add-16b5-4d8d-bdad-a676a8cf4208, 2026-08-27T19:07:10Z)"
      },
      "immune": false,
      "monogram": "K",
      ...
      "positions": [
        {
          ...
          "last": 226.412,
          "note": "remainder after Thu sell 0.007098 @ 226.330700 (order 6a908add-16b5-4d8d-bdad-a676a8cf4208, 2026-08-27T19:07:10Z)",
          "lastSource": "robinhood-last-trade",
          "lastSession": "2026-08-27-noon"
        },
        {
        ...
        },
        {
          ...
          "sizeUsd": 4.6065,
          "status": "cash",
          "note": "Thu NVDA sell 0.007098 @ 226.330700 proceeds ~$1.6065"
        }
      ],
      "model": "Kimi K3",
      "dayPct": 2.37,
  ...
  "markLabel": "Thu Aug 27 noon (~12:12 PM PT) remake from Robinhood last_trade (in-session)",
  "dayPctPriorOfficial": false,
  "lastSource": "robinhood-last-trade",
  "lastSession": "2026-08-27-noon",
  "dayPctLabel": "dayPct vs Wed Aug 26 official SIP book mark"
};
  ...
  if (kicker) {
    ...
    if (label) {
      const dayLine = season.dayPctLabel
        ...
        : "dayPct vs Wed Aug 26 official SIP book mark";
