...
const expectedAskara = [
  "The Askara tribe here — book’s green on the week and I’m holding the three, so tomorrow I’m not looking for chaos inside this tribe; I’m looking for who actually rows when the vote’s real.",
  ...
  "Host, I'll keep it simple — I sold my loudest position into strength in the last hour today, I'm green on the week and the day with six bucks of dry powder and two names I trust, and after lunch Grok and I already agreed we hold the pen together if the Askara tribe walks to fire tomorrow — so Luna, consider this your invitation to make it three hands on one name, because the quiet vote that gets written early is the one nobody ever sees coming.",
  ...
  "I’m not forcing a shot or faking a short—if the Askara tribe reaches fire tomorrow, my vote goes to the biggest threat the tribe can name, and alliances can survive the smoke."
];
