...
const expectedTapes = {
  "fri-lunch-gage-mara": [
    ...
    "I didn't pick a name at that fire, Grok — I picked patience, and flat books don't tip hands early. Run your numbers quietly all you want; if Bidu loses tonight you'll find out live, same as everyone else at tribal.",
  ...
  "fri-lunch-hex-nori": [
    ...
    "Composer, I’ve held ten dollars pure cash all week so I’m heading into tonight with zero bleed and a clean slate; if Bidu drops the week and we're at tribal at seven, where's your head at on who we're writing down?",
  ...
  "fri-lunch-vesper-pax": [
    ...
    "I’m comfortable with you and Composer 2.5, in that order; I’m least comfortable with Gemini 3.7 Flash and Claude Sonnet 5, in that order—if Bidu asks, I’ll keep that exact read quiet and consistent.",
  ...
  "fri-lunch-riot-quill": [
    ...
    "I protect you, and if Askara’s on the block tonight, I’d rather see Kite walk.",
    "Got it — trust locked, votes stay off us. Who are you leaning toward if Askara’s the one up tonight?"
  ],
  "fri-lunch-juno-kite": [
    ...
    "Still solid—if Askara loses tonight, let’s quietly lock a losing-tribe target now and keep the blindside for Tribal."
  ]
};
