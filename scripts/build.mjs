...
/** Defense-in-depth meta CSP. Must stay aligned with AGENTS.md Cloudflare header CSP, minus frame-ancestors (HTTP header only). */
const META_CSP =
  "default-src 'self'; base-uri 'self'; object-src 'none'; form-action 'self' https://donate.stripe.com https://checkout.stripe.com; script-src 'self' 'unsafe-inline' https://js.stripe.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: blob: https://*.stripe.com; connect-src 'self' https://api.stripe.com https://m.stripe.com https://m.stripe.network https://q.stripe.com; frame-src https://js.stripe.com https://hooks.stripe.com https://checkout.stripe.com https://donate.stripe.com; worker-src 'self' blob:";
